...
| S6 | 看项目是否赚钱 | 经营 Tab → 项目盈亏；工作室顶部 P&L 条 |
...
- 左：产出物列表（PRD / Demo / 邮件 / 备忘）+ version / Demo 链接
- 右：Markdown 预览 + MD/PDF/ZIP 导出
- 上：结项清单（HITL-3 后）+ 项目盈亏条
...
| **周报** | CEO 一页纸：Pipeline 快照、待你拍板、经营快照、四段正文、五部门摘要 |
...
| 工作室 | 产出 version、Demo 外链、顶部 P&L 条 |
